...
$email_subject = "Nuevo contacto desde la pagina bpms.com.ar";
$email_message = "<html><head></head><body>";
$email_message .= "<p>Ha recibido un nuevo contacto desde la página bpms.com.ar</p>";
$email_message .= "<p>Datos el formulario:</p>";
$email_message .= "<div>";
